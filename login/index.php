...
// Verifica si la sesión indica un inicio de sesión exitoso
...
// Si hay un mensaje en la sesión, lo muestra y luego lo limpia
if (isset($_SESSION['message'])) {
    $mensaje = $_SESSION['message'];
    $success = $_SESSION['success'] ? 'success' : 'error';
